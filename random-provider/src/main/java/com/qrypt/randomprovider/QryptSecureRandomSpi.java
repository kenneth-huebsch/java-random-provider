...
/**
 * Qrypt SecureRandom implementation that wraps sun.security.provider.SecureRandom,
 * replacing SeedGenerator with Qrypt RandomStore
 *
 */
public final class QryptSecureRandomSpi extends SecureRandomSpi
        implements java.io.Serializable {

    private static final long serialVersionUID = 3581829991155417890L;
    ...
    public QryptSecureRandomSpi() {
        this.randomStore=QryptSingleQueueRandomStore.getInstance();
        init(null);
    }
     ...
     * @param seed the seed.
     */
    private QryptSecureRandomSpi(byte[] seed) {
        this.randomStore=QryptSingleQueueRandomStore.getInstance();
        init(seed);
    }

    private QryptSecureRandomSpi(RandomStore randomStore) {
...
//            //this call below might throw runtime exception when randomstore is empty, is there a way to
//            randomStore.nextBytes(b);
//            engineSetSeed(b);
//        }
    }
    ...
    private static class SeederHolder {
        ...
        private static final QryptSecureRandomSpi seeder;
        ...
        static {
             ...
             */
            seeder = new QryptSecureRandomSpi(QryptSingleQueueRandomStore.getInstance());
//            byte [] b = new byte[DIGEST_SIZE];
//            SeedGenerator.generateSeed(b);
